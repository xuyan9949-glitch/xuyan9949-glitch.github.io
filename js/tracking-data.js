...
const trackingData = {
  ...
  "a-shares": [
    // 置顶：东山精密（持有）
    {
      ...
      keyMetrics: [
        { metric: "2026H1归母净利润29–30亿元", status: "超预期增长", importance: "高", trend: "上行", note: "同比增长282.58%–295.78%，但包含数据中心产业投资收益。" },
        { metric: "2026H1扣非净利润24–25亿元", status: "主营强化", importance: "高", trend: "上行", note: "同比增长265.41%–280.63%，主营利润质量明显改善。" },
        { metric: "2026Q2扣非净利润约13.41–14.41亿元", status: "推算值", importance: "高", trend: "环比加速", note: "按半年预告减去一季度数据倒推，环比增长约26.6%–36.0%。" },
        { metric: "索尔思2026Q1利润贡献52.92%", status: "核心引擎", importance: "高", trend: "快速提升", note: "光模块业务已经贡献公司超过一半利润。" },
        { metric: "光模块2025年毛利率36.74%", status: "高毛利", importance: "高", trend: "待持续验证", note: "显著高于电子电路17.59%的毛利率，是公司利润率提升的核心来源。" },
        { metric: "光芯片及光模块扩产12亿美元", status: "产能建设中", importance: "高", trend: "扩张", note: "扩产反映需求与产能缺口，但需跟踪资金压力、折旧、良率和实际产能利用率。" },
        { metric: "2026Q1经营现金流11.27亿元", status: "需要观察", importance: "中", trend: "同比下降", note: "同比下降17.48%，利润高增长尚未完全同步转化为现金流增长。" },
        { metric: "2026H1非经常性损益约4–6亿元", status: "需要拆分", importance: "高", trend: "增加", note: "主要涉及数据中心产业投资收益，不能直接按主营业务给予高成长估值。" }
      ],
      catalysts: [
        { catalyst: "2026年半年度报告正式披露", timeWindow: "2026-08-22", importance: "高", status: "待验证", evidence: "公司已披露上半年业绩预告，正式报告将提供业务拆分和现金流数据。", direction: "双向" },
        { catalyst: "光模块新增产能爬坡及新客户导入", timeWindow: "2026H2", importance: "高", status: "进行中", evidence: "公司表示新增产能爬坡和新客户导入符合预期。", direction: "利多" },
        { catalyst: "12亿美元光芯片及光模块扩产落地", timeWindow: "2026H2–2027", importance: "高", status: "建设中", evidence: "公司已审议通过扩产方案，现有产能不能满足客户中长期需求。", direction: "双向" },
        { catalyst: "光芯片良率及自供能力提升", timeWindow: "2026H2–2027", importance: "高", status: "持续优化", evidence: "公司明确目前处于产能投放期，良率仍在持续提升。", direction: "利多" },
        { catalyst: "800G持续放量及1.6T产品交付", timeWindow: "2026H2–2027", importance: "高", status: "待订单验证", evidence: "行业需求向更高速率产品升级，公司产品结构正在向高规格产品迁移。", direction: "利多" },
        { catalyst: "AI PCB订单和盈利贡献提升", timeWindow: "2026H2–2027", importance: "中高", status: "待量化验证", evidence: "公司将AI PCB明确定位为把握AI机会的进攻赛道。", direction: "利多" },
        { catalyst: "数据中心产业投资收益进一步兑现", timeWindow: "2026H2", importance: "中", status: "已部分兑现", evidence: "上半年业绩预告确认相关投资已形成收益。", direction: "双向" },
        { catalyst: "H股发行及上市进程", timeWindow: "时间待定", importance: "中", status: "推进中", evidence: "可能增强海外融资能力，但需关注发行规模、价格和股本摊薄。", direction: "双向" }
      ],
      valuation: {
        ...
        tiers: [
          { label: "防守情景", price: "204–230元", logic: "市场下调2027年光通信利润预期，但中报和订单基本面没有实质恶化。该区间更接近高波动阶段的恐慌定价，可考虑分批低吸。" },
          { label: "基准情景", price: "260–350元", logic: "光模块产能、新客户、良率和AI PCB业务按计划推进，2026年利润达到75–85亿元，2027年进入明显放量期。350元附近对应花旗SOTP目标价上沿。" },
          { label: "强牛情景", price: "350元以上", logic: "需要1.6T、光芯片自供、良率提升和AI PCB同时超预期，且2027年利润向250–300亿元靠拢。属于高兑现要求情景，不应仅凭题材给予。" }
        ]
      },
      operationPlan: {
