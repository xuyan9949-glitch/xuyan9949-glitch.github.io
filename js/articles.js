const articles = [
  {
    "id": "storage-tl-dr-20260721",
    "title": "A股7月21日复盘：科技股首次强反攻后的概率推演",
    "date": "2026-07-21",
    "category": "A股",
    "subcategory": "存储",
    "tags": [
    ...
    "pinned": false,
    "summary": "强趋势行情（2024年2月）",
    "keywords": "存储 TSM 东山精密 中际旭创 新易盛 生益科技 寒武纪 光通信 AI电子材料 见贤思齐 产业链分析 对比分析 TL DR AI PCB",
    "file": "/articles/storage-tl-dr-20260721/"
  },
  {
  ...
  },
  {
    ...
    "pinned": false,
    "summary": "特朗普账户选择7月4日（独立宣言250周年）启动，不是行政安排，而是一场经过设计的政治仪式。四项政治目标：绑定建国历史、全民股东资本主义、爱国主义与持有美股绑定、个人品牌嵌入跨代际制度。短期资金有限，长期制度意义高于行情意义。",
    "keywords": "特朗普账户 Trump Accounts 7月4日 独立日 250周年 儿童账户 全民股东 所有权社会 401(k) 政治遗产 长期资金",
    "file": "/articles/trump-account-7-4/"
  },
  {
  ...
  },
  {
    ...
    "pinned": false,
    "summary": "「诺曼底72小时」观后反思。气象官斯塔格在艾森豪威尔和满屋将军面前坚持数据判断，妻子医院被炸仍完成工作，丘吉尔称其为天才。提炼八个核心特质，以及对投资、工作和学习的启示。",
    "keywords": "斯塔格 Stagg 诺曼底 气象 决策 专业主义 投资心法 压力管理 认知 数据信仰",
