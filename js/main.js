document.addEventListener('DOMContentLoaded', () => {
    ...
    if (researchEl) {
        const research = [
            { icon: '\u{1F9E9}', title: '\u7F8E\u80A1\u79D1\u6280\u6295\u8D44', tag: '\u8D26\u6237\u4E3B\u7EBF', desc: '\u4EE5\u7F8E\u80A1\u79D1\u6280\u9F99\u5934\u548C\u9AD8\u5F39\u6027\u6210\u957F\u80A1\u4E3A\u6838\u5FC3\uFF0C\u91CD\u70B9\u8DDF\u8E2A\u534A\u5BFC\u4F53\u3001AI \u7B97\u529B\u3001\u5149\u4E92\u8FDE\u3001\u52A0\u5BC6\u91D1\u878D\u4E0E\u592A\u7A7A\u57FA\u7840\u8BBE\u65BD\u3002', stocks: 'NVDA \u00B7 AVGO \u00B7 MU \u00B7 TSLA \u00B7 RKLB \u00B7 ASTS' },
            { icon: '\u26A1', title: 'AI \u57FA\u7840\u8BBE\u65BD', tag: '\u6838\u5FC3\u4E3B\u7EBF', desc: '\u4ECE\u4E91\u5382\u5546 CapEx \u51FA\u53D1\uFF0C\u8DDF\u8E2A GPU\u3001HBM\u3001PCB\u3001\u5149\u6A21\u5757\u3001\u6DB2\u51B7\u3001\u7535\u529B\u3001\u6838\u7535\u7B49\u73AF\u8282\u7684 BOM \u4EF7\u503C\u91CF\u91CD\u4F30\u3002', stocks: 'GPU \u00B7 HBM \u00B7 PCB \u00B7 \u5149\u6A21\u5757 \u00B7 \u6DB2\u51B7 \u00B7 \u7535\u529B' },
            { icon: '\u{1F52C}', title: '\u5149\u901A\u4FE1 / \u534A\u5BFC\u4F53', tag: '\u6838\u5FC3\u4E3B\u7EBF \u00B7 \u4E0A\u6E38\u74F6\u9888', desc: '\u91CD\u70B9\u8DDF\u8E2A InP \u886C\u5E95\u3001EML \u6FC0\u5149\u5668\u3001\u7845\u5149\u3001DSP\u3001\u5148\u8FDB\u5C01\u88C5\u4E0E\u534A\u5BFC\u4F53\u8BBE\u5907\uFF0C\u5BFB\u627E AI \u65F6\u4EE3\u6700\u4E0A\u6E38\u7684\u7269\u7406\u5165\u53E3\u3002', stocks: 'COHR \u00B7 LITE \u00B7 AAOI \u00B7 AXTI \u00B7 MRVL' },
            { icon: '\u{1F4C8}', title: 'A \u80A1\u4EA7\u4E1A\u6620\u5C04', tag: '\u4EA4\u6613\u589E\u5F3A', desc: '\u4ECE\u7F8E\u80A1\u5927\u79D1\u6280\u8D22\u62A5\u3001AI CapEx \u4E0E\u4EA7\u4E1A\u94FE\u8BA2\u5355\u51FA\u53D1\uFF0C\u5BFB\u627E A \u80A1\u4E2D\u7684\u9F99\u4E00\u3001\u9F99\u4E8C\u3001\u4E8C\u9636\u6750\u6599\u8BBE\u5907\u4E0E\u540E\u6392\u8865\u6DA8\u673A\u4F1A\u3002', stocks: '\u4E1C\u5C71\u7CBE\u5BC6 \u00B7 \u592A\u6668\u5149 \u00B7 \u4E09\u73AF\u96C6\u56E2 \u00B7 \u4EA8\u901A\u5149\u7535' },
            { icon: '\u{1F9E0}', title: '\u6295\u8D44\u65B9\u6CD5\u8BBA', tag: '\u5E95\u5C42\u6846\u67B6', desc: '\u7528\u7B2C\u4E00\u6027\u539F\u7406\u62C6\u516C\u53F8\uFF0C\u7528 Follow the Money \u627E\u8D44\u91D1\u6D41\u5411\uFF0C\u7528\u4E09\u7C7B\u8D44\u4EA7\u6846\u67B6\u5224\u65AD\u4F30\u503C\u4E0E\u4E70\u70B9\u3002', stocks: '\u7B2C\u4E00\u6027\u539F\u7406 \u00B7 \u8D22\u52A1\u8D28\u91CF \u00B7 \u5468\u671F\u4F4D\u7F6E \u00B7 \u4EA4\u6613\u7EAA\u5F8B' },
            { icon: '\u{1FA99}', title: '\u7A33\u5B9A\u5E01 / \u52A0\u5BC6\u91D1\u878D', tag: '\u9AD8\u5F39\u6027\u4E3B\u7EBF \u00B7 \u76D1\u7BA1\u50AC\u5316', desc: '\u8DDF\u8E2A USDC \u6D41\u901A\u91CF\u3001\u77ED\u7AEF\u5229\u7387\u3001\u50A8\u5907\u6536\u5165\u3001\u76D1\u7BA1\u6CD5\u6848\u4E0E\u94FE\u4E0A\u751F\u6001\uFF0C\u7814\u7A76\u7A33\u5B9A\u5E01\u5546\u4E1A\u6A21\u5F0F\u548C\u52A0\u5BC6\u5238\u5546\u91CD\u4F30\u3002', stocks: 'CRCL \u00B7 COIN \u00B7 HOOD \u00B7 BTC' },
        ];
        researchEl.innerHTML = research.map(r => `
            <div class="research-card">
                ...
                <h3>${r.title}</h3>
                <p>${r.desc}</p>
                <div class="research-stocks">${r.stocks}</div>
            </div>
        `).join('');
    }
