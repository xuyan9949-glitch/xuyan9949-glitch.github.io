  ...
  assetGroups: [
    {
      label: "风险资产",
      items: [
        { name: "QQQ（纳指）",  close: "705.06（-4.8%）",       structure: "单边下跌",  level: "极端大跌",     meaning: "成长股风险偏好急剧下降" },
    ...
    },
    {
      label: "亚洲市场",
      items: [
        { name: "KOSPI（韩综）",  close: "175.19（-14.1%）",     structure: "崩跌",     level: "极端",     meaning: "韩国政治风险叠加半导体恐慌" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "DXY（美元指数）",  close: "UUP 28.02（+0.65%）",               structure: "单边走强",          level: "流动性收紧", meaning: "全球风险资产承压" },
      ],
    },
    {
      label: "商品与避险",
